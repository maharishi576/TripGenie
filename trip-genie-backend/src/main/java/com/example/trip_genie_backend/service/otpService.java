...
// Temporarily commented out for demo purposes - requires Brevo/Sendinblue API dependencies
/*
...
public class OtpService {
     ...
     * TEMPORARILY DISABLED - Requires Brevo API dependencies
     */
    private boolean sendEmail(String to, String otp) {
        // Email sending temporarily disabled for demo purposes
        System.out.println("Email sending disabled - would send OTP " + otp + " to " + to);
        return true; // Simulate successful sending for demo
